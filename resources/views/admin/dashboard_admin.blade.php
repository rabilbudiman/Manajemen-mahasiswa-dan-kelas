                        ...
                        <div class="card bg-primary h-100 text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="me-3">
                                        <div class="fw-bold text-lg">MAHASISWA</div>
                                    </div>
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between small">
                                <h5 class="text-white">Jumlah: {{ $jumlah_mahasiswa }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-3 mb-4">
                        <div class="card bg-warning h-100 text-white">
                            ...
                            <div class="card-footer d-flex align-items-center justify-content-between small">
                                <h5 class="text-white">Jumlah: {{ $jumlah_user }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-3 mb-4">
                        <div class="card bg-success h-100 text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="me-3">
                                        <div class="fw-bold text-lg">KELAS</div>
                                    </div>
                    ...
                    <div class="col-lg-6 col-xl-3 mb-4">
                        <div class="card bg-danger h-100 text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="me-3">
                                        <div class="fw-bold text-lg">MATA KULIAH</div>
                                    </div>
